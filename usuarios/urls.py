...
urlpatterns = [
    ...
    path('carreras-disponibles/', views.CarreraPublicListView.as_view(), name='carrera-public-list'),
    path('carreras-disponibles/<int:pk>/', views.CarreraPublicDetailView.as_view(), name='carrera-public-detail'),
